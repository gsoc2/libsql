...
[libSQL](https://kengine.khulnasoft.com/libsql) is an open source, open contribution fork of SQLite, created and maintained by [gSOC2](https://kengine.khulnasoft.com). We aim to evolve it to suit many more use cases than SQLite was originally designed for, and plan to use third-party OSS code wherever it makes sense.
...
* [WebAssembly User Defined Functions](https://blog.kengine.khulnasoft.com/webassembly-functions-for-your-sqlite-compatible-database-7e1ad95a2aa7)
...
You can read more about our goals an motivation in our [product vision](https://kengine.khulnasoft.com/libsql-manifesto) and our [announcement article](https://glaubercosta-11125.medium.com/sqlite-qemu-all-over-again-aedad19c9a1c)
